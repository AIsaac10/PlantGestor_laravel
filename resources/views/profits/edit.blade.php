...
<body class="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg w-full max-w-sm">
        ...
        <form action="{{ route('profits.update', $profit->id) }}" method="POST" class="space-y-4">
            @method("PUT")
            @csrf
            ...
            <div>
                ...
                <input 
                    type="text" 
                    id="description_profit" 
                    name="description_profit" 
                    value="{{ old('description_profit', $profit->description_profit) }}"
            ...
            <div>
                ...
                <input 
                    ...
                    step="0.01"
                    id="quantity_profit" 
                    name="quantity_profit" 
                    value="{{ old('quantity_profit', $profit->quantity_profit) }}"
                    class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-800">
            </div>
    ...
    <a class="inline-block hover:text-gray-500 text-bg-gray-800 text-sm px-3 py-1 rounded transition mt-3"
