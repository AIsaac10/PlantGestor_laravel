...
<body class="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg w-full max-w-sm">
        ...
        <form action="{{ route('costs.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" id="description_cost" name="description_cost"
                       value="{{ old('description_cost') }}"
            ...
            <div>
                ...
                <input type="number" step="0.01" id="quantity_cost" name="quantity_cost"
                       value="{{ old('quantity_cost') }}"
                       class="w-full border border-gray-300 rounded-md p-2 
                              focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-800">
            </div>
